  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center w-full min-h-screen h-full">
        <div className="flex flex-col lg:flex-row items-center justify-center max-w-[1500px]">
          <div className="lg:w-1/3 flex flex-col justify-center h-full p-4">
          ...
          <main className="lg:p-4 flex flex-col gap-4 items-center h-full justify-center text-white lg:w-2/3 text-xs">
            <section className="gap-2 p-2 flex">
