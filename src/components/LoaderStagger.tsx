  ...
  return (
    <div className="w-full h-screen absolute flex flex-col items-center justify-center">
      <div className="max-h-[650px] h-max max-w-[1200px] w-[90vw] p-4 overflow-hidden">
        ...
        >
          <g id="S-Stagger">
            <g className='translate-x-[500px] animate-[stagger_1s_2150ms_forwards] ' id="row-33">
              <rect
                id="Rectangle 349"
                x="1090"
                y="3700"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_2100ms_forwards]'id="row-32">
              <rect
                id="Rectangle 351"
                width="900"
                height="50"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_2050ms_forwards] 'id="row-31">
              <rect
                id="Rectangle 465"
                y="3468"
                width="800"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_2000ms_forwards] 'id="row-30">
              <rect
                id="Rectangle 352"
                x="1684"
                y="3402"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1900ms_forwards] 'id="row-29">
              <rect
                id="Rectangle 354"
                width="700"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1850ms_forwards] 'id="row-28">
              <rect
                id="Rectangle 348"
                x="551"
                y="3120"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1800ms_forwards] 'id="row-27">
              <rect
                id="Rectangle 350"
                width="900"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1750ms_forwards] 'id="row-26">
              <rect
                id="Rectangle 344"
                x="992"
                y="2888"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1700ms_forwards] 'id="row-25">
              <rect
                id="Rectangle 275"
                width="300"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1650ms_forwards] 'id="row-24">
              <rect
                id="Rectangle 282"
                x="1506"
                y="2705"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1600ms_forwards] 'id="row-23">
              <rect
                id="Rectangle 280"
                width="800"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1550ms_forwards] 'id="row-22">
              <rect
                id="Rectangle 278"
                x="1417"
                y="2478"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1500ms_forwards] 'id="row-21">
              <rect
                id="Rectangle 287"
                width="700"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1450ms_forwards] 'id="row-20">
              <rect
                id="Rectangle 284"
                x="776"
                y="2195"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1400ms_forwards] 'id="row-19">
              <rect
                id="Rectangle 281"
                x="570"
                y="2084"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1350ms_forwards] 'id="row-18">
              <rect
                id="Rectangle 254"
                width="800"
                height="50"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1300ms_forwards] 'id="row-17">
              <rect
                id="Rectangle 258"
                width="900"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1250ms_forwards] 'id="row-16">
              <rect
                id="Rectangle 265"
                x="1695"
                y="1790"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1200ms_forwards] 'id="row-15">
              <rect
                id="Rectangle 251"
                width="300"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1150ms_forwards] 'id="row-14">
              <rect
                id="Rectangle 253"
                x="643"
                y="1508"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1100ms_forwards] 'id="row-13">
              <rect
                id="Rectangle 255"
                width="800"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_1050ms_forwards] 'id="row-12">
              <rect
                id="Rectangle 248"
                x="830"
                y="1274"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_1000ms_forwards] 'id="row-11">
              <rect
                id="Rectangle 272"
                width="500"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_950ms_forwards] 'id="row-10">
              <rect
                id="Rectangle 204"
                width="800"
                height="50"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_900ms_forwards] 'id="row-9">
              <rect
                id="Rectangle 215"
                x="257"
                y="978"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_850ms_forwards] 'id="row-8">
              <rect
                id="Rectangle 212"
                width="700"
                height="50"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_800ms_forwards] 'id="row-7">
              <rect
                id="Rectangle 218"
                x="1347"
                y="746"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_750ms_forwards] 'id="row-6">
              <rect
                id="Rectangle 214"
                width="200"
                height="50"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_700ms_forwards] 'id="row-5">
              <rect
                id="Rectangle 181"
                width="800"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_650ms_forwards] 'id="row-4">
              <rect
                id="Rectangle 186"
                x="705"
                y="398"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_600ms_forwards] 'id="row-3">
              <rect
                id="Rectangle 168"
                width="700"
                height="50"
            ...
            <g className='-translate-x-[500px] animate-[stagger_1s_550ms_forwards] 'id="row-2">
              <rect
                id="Rectangle 35"
                x="1646"
                y="116"
            ...
            <g className='translate-x-[500px] animate-[stagger_1s_500ms_forwards] 'id="row-1">
              <rect
                id="Rectangle 161"
                width="200"
                height="50"
